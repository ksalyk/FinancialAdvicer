...
object StringKeys {
    ...
    // ── AchievementsScreen ───────────────────────────────────────────
    const val UI_ACH_TITLE                    = "ui_ach_title"
    const val UI_ACH_SUBTITLE                 = "ui_ach_subtitle"
    const val UI_ACH_MENU_SUBTITLE            = "ui_ach_menu_subtitle"
    const val UI_ACH_UNLOCKED_LABEL           = "ui_ach_unlocked_label"
    const val UI_ACH_COUNT_PATTERN            = "ui_ach_count_pattern"
    const val UI_ACH_SECTION_GAME             = "ui_ach_section_game"
    const val UI_ACH_SECTION_SCAMS            = "ui_ach_section_scams"
    const val UI_ACH_SCAM_HINT                = "ui_ach_scam_hint"
    const val UI_ACH_RARITY_COMMON            = "ui_ach_rarity_common"
    const val UI_ACH_RARITY_RARE              = "ui_ach_rarity_rare"
    const val UI_ACH_RARITY_LEGEND            = "ui_ach_rarity_legend"
    const val UI_ACH_STATUS_UNLOCKED          = "ui_ach_status_unlocked"
    const val UI_ACH_UNLOCKED_VIA             = "ui_ach_unlocked_via"
    const val UI_ACH_STATUS_LOCKED_GAME       = "ui_ach_status_locked_game"
    const val UI_ACH_STATUS_LOCKED_SCAM       = "ui_ach_status_locked_scam"
    const val UI_ACH_AGE_PATTERN              = "ui_ach_age_pattern"
    const val UI_ACH_TASK_LABEL               = "ui_ach_task_label"
    const val UI_ACH_HINT_LABEL               = "ui_ach_hint_label"
    const val UI_ACH_TEASER_TITLE             = "ui_ach_teaser_title"
    const val UI_ACH_TEASER_TEXT              = "ui_ach_teaser_text"
    const val UI_ACH_STORY_TITLE              = "ui_ach_story_title"
    const val UI_ACH_ORIGIN_LABEL             = "ui_ach_origin_label"
    const val UI_ACH_VARIANT_LABEL            = "ui_ach_variant_label"
    const val UI_ACH_MODERN_LABEL             = "ui_ach_modern_label"
    const val UI_ACH_NOW                      = "ui_ach_now"
    const val UI_ACH_SIGNS_TITLE              = "ui_ach_signs_title"
    const val UI_ACH_FB_QUESTION              = "ui_ach_fb_question"
    const val UI_ACH_FB_THANKS                = "ui_ach_fb_thanks"
