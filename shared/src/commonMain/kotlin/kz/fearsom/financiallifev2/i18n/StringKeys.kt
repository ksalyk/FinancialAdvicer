...
object StringKeys {
    ...
    // ── OnboardingScreen ─────────────────────────────────────────────
    const val UI_ONBOARD_SKIP                 = "ui_onboard_skip"
    const val UI_ONBOARD_NEXT                 = "ui_onboard_next"
    const val UI_ONBOARD_START                = "ui_onboard_start"
    const val UI_ONBOARD_HAVE_ACCOUNT         = "ui_onboard_have_account"
    // Screen 1 — loss statistics (world / Asia / Kazakhstan)
    const val UI_ONBOARD_S1_LABEL             = "ui_onboard_s1_label"
    const val UI_ONBOARD_S1_TITLE             = "ui_onboard_s1_title"
    const val UI_ONBOARD_S1_SUBTITLE          = "ui_onboard_s1_subtitle"
    const val UI_ONBOARD_S1_WORLD_LABEL       = "ui_onboard_s1_world_label"
    const val UI_ONBOARD_S1_WORLD_VALUE       = "ui_onboard_s1_world_value"
    const val UI_ONBOARD_S1_WORLD_UNIT        = "ui_onboard_s1_world_unit"
    const val UI_ONBOARD_S1_WORLD_DESC        = "ui_onboard_s1_world_desc"
    const val UI_ONBOARD_S1_ASIA_LABEL        = "ui_onboard_s1_asia_label"
    const val UI_ONBOARD_S1_ASIA_VALUE        = "ui_onboard_s1_asia_value"
    const val UI_ONBOARD_S1_ASIA_UNIT         = "ui_onboard_s1_asia_unit"
    const val UI_ONBOARD_S1_ASIA_DESC         = "ui_onboard_s1_asia_desc"
    const val UI_ONBOARD_S1_KZ_LABEL          = "ui_onboard_s1_kz_label"
    const val UI_ONBOARD_S1_KZ_VALUE          = "ui_onboard_s1_kz_value"
    const val UI_ONBOARD_S1_KZ_UNIT           = "ui_onboard_s1_kz_unit"
    const val UI_ONBOARD_S1_KZ_DESC           = "ui_onboard_s1_kz_desc"
    const val UI_ONBOARD_S1_RECOVER_VALUE     = "ui_onboard_s1_recover_value"
    const val UI_ONBOARD_S1_RECOVER_TEXT      = "ui_onboard_s1_recover_text"
    const val UI_ONBOARD_S1_SOURCES           = "ui_onboard_s1_sources"
    // Screen 2 — game + education
    const val UI_ONBOARD_S2_LABEL             = "ui_onboard_s2_label"
    const val UI_ONBOARD_S2_TITLE             = "ui_onboard_s2_title"
    const val UI_ONBOARD_S2_SUBTITLE          = "ui_onboard_s2_subtitle"
    const val UI_ONBOARD_S2_CHAT_DATE         = "ui_onboard_s2_chat_date"
    const val UI_ONBOARD_S2_SCAM_MSG          = "ui_onboard_s2_scam_msg"
    const val UI_ONBOARD_S2_ASAN_MSG          = "ui_onboard_s2_asan_msg"
    const val UI_ONBOARD_S2_OPT_WRONG         = "ui_onboard_s2_opt_wrong"
    const val UI_ONBOARD_S2_OPT_WRONG_BADGE   = "ui_onboard_s2_opt_wrong_badge"
    const val UI_ONBOARD_S2_OPT_RIGHT         = "ui_onboard_s2_opt_right"
    const val UI_ONBOARD_S2_OPT_RIGHT_BADGE   = "ui_onboard_s2_opt_right_badge"
    const val UI_ONBOARD_S2_FACT              = "ui_onboard_s2_fact"
    // Screen 3 — scam patterns are similar
    const val UI_ONBOARD_S3_LABEL             = "ui_onboard_s3_label"
    const val UI_ONBOARD_S3_TITLE             = "ui_onboard_s3_title"
    const val UI_ONBOARD_S3_SUBTITLE          = "ui_onboard_s3_subtitle"
    const val UI_ONBOARD_S3_CHIP_1            = "ui_onboard_s3_chip_1"
    const val UI_ONBOARD_S3_CHIP_2            = "ui_onboard_s3_chip_2"
    const val UI_ONBOARD_S3_CHIP_3            = "ui_onboard_s3_chip_3"
    const val UI_ONBOARD_S3_CHIP_4            = "ui_onboard_s3_chip_4"
    const val UI_ONBOARD_S3_CHIP_5            = "ui_onboard_s3_chip_5"
    const val UI_ONBOARD_S3_CHIP_6            = "ui_onboard_s3_chip_6"
    const val UI_ONBOARD_S3_STAT_VALUE        = "ui_onboard_s3_stat_value"
    const val UI_ONBOARD_S3_STAT_TEXT         = "ui_onboard_s3_stat_text"
    const val UI_ONBOARD_S3_NOTE              = "ui_onboard_s3_note"
    // Screen 4 — CTA
    const val UI_ONBOARD_S4_LABEL             = "ui_onboard_s4_label"
    const val UI_ONBOARD_S4_TITLE             = "ui_onboard_s4_title"
    const val UI_ONBOARD_S4_SUBTITLE          = "ui_onboard_s4_subtitle"
