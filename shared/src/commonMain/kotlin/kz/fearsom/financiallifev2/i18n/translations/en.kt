...
val enStrings: Map<String, String> = mapOf(
    ...
    "ui_onboard_skip"                to "Skip",
    "ui_onboard_next"                to "Next",
    "ui_onboard_start"               to "Start playing",
    "ui_onboard_have_account"        to "I already have an account",
    "ui_onboard_s1_label"            to "THE SCALE OF THE PROBLEM",
    "ui_onboard_s1_title"            to "Scammers steal more than entire countries earn",
    "ui_onboard_s1_subtitle"         to "Every year sets a new record. And almost nobody gets their money back.",
    "ui_onboard_s1_world_label"      to "WORLD",
    "ui_onboard_s1_world_value"      to "$1.03",
    "ui_onboard_s1_world_unit"       to "trillion",
    "ui_onboard_s1_world_desc"       to "stolen by scammers in 12 months",
    "ui_onboard_s1_asia_label"       to "ASIA",
    "ui_onboard_s1_asia_value"       to "$688",
    "ui_onboard_s1_asia_unit"        to "billion",
    "ui_onboard_s1_asia_desc"        to "lost across the region in the same year",
    "ui_onboard_s1_kz_label"         to "KAZAKHSTAN",
    "ui_onboard_s1_kz_value"         to "17.5",
    "ui_onboard_s1_kz_unit"          to "bln ₸",
    "ui_onboard_s1_kz_desc"          to "damage to citizens from digital fraud",
    "ui_onboard_s1_recover_value"    to "4%",
    "ui_onboard_s1_recover_text"     to "of victims ever get their money back. The rest don't.",
    "ui_onboard_s1_sources"          to "Sources: Global State of Scams Report 2024 (GASA) · MIA of Kazakhstan",
    "ui_onboard_s2_label"            to "HOW IT WORKS",
    "ui_onboard_s2_title"            to "It's a game. And a training simulator.",
    "ui_onboard_s2_subtitle"         to "A financial life sim in chat format. You live someone else's life, make decisions — and see the consequences, **without losing a single real tenge.**",
    "ui_onboard_s2_chat_date"        to "April · 2024",
    "ui_onboard_s2_scam_msg"         to "\"Bank security service. There's a suspicious transaction on your card. Tell us the SMS code to cancel it.\"",
    "ui_onboard_s2_asan_msg"         to "Asan: a real bank **never** asks for your SMS code.",
    "ui_onboard_s2_opt_wrong"        to "Give the code",
    "ui_onboard_s2_opt_wrong_badge"  to "−100%",
    "ui_onboard_s2_opt_right"        to "Hang up",
    "ui_onboard_s2_opt_right_badge"  to "✓ correct",
    "ui_onboard_s2_fact"             to "**Learn by playing.** One run takes about 10 minutes. Mistakes here are free.",
    "ui_onboard_s3_label"            to "THE KEY SECRET",
    "ui_onboard_s3_title"            to "Almost every scheme looks the same.",
    "ui_onboard_s3_subtitle"         to "A call from the \"bank\". A sudden \"prize\". An urgent transfer to a \"relative\". There are actually only a few tricks. **Learn one — recognize a hundred.**",
    "ui_onboard_s3_chip_1"           to "Urgency",
    "ui_onboard_s3_chip_2"           to "Pressure",
    "ui_onboard_s3_chip_3"           to "Secrecy",
    "ui_onboard_s3_chip_4"           to "\"SMS code\"",
    "ui_onboard_s3_chip_5"           to "Easy money",
    "ui_onboard_s3_chip_6"           to "Look-alike link",
    "ui_onboard_s3_stat_value"       to "90%",
    "ui_onboard_s3_stat_text"        to "of all scams are built on just **5–6 tricks**. Learn them — and most schemes become obvious.",
    "ui_onboard_s3_note"             to "Only the set dressing changes: a bank, a courier, an \"investment\", a friend in a messenger. The skeleton of the scheme stays the same.",
    "ui_onboard_s4_label"            to "READY?",
    "ui_onboard_s4_title"            to "10 minutes of play will teach you to notice what others miss.",
    "ui_onboard_s4_subtitle"         to "No lectures, no boring lessons. Just play — the skill stays with you.",
    ...
    "ui_chat_action_label"           to "Your move",
    "ui_chat_writing"                to "typing...",
    "ui_chat_option_risky"           to "RISKY",
    "ui_chat_option_safe"            to "SAFE",
    // ── Asan AI advisor ──────────────────────────────────────────────
    "ui_asan_title"                  to "Asan",
    "ui_asan_status"                 to "AI advisor · online",
    "ui_asan_placeholder"            to "Ask Asan…",
    "ui_asan_greeting"               to "Look at the promise: \"2,000 → 4,000 in a month\". A guaranteed 100% return is the biggest red flag. That's exactly how a pyramid scheme works.",
    "ui_asan_reply_generic"          to "\"Everyone is investing\" is bait, not an argument. When the inflow of newcomers dries up, the last ones in lose everything.",
    "ui_asan_flag_guarantee"         to "Guaranteed returns",
    "ui_asan_flag_upfront"           to "Money upfront",
    "ui_asan_flag_urgency"           to "Urgency pressure",
    "ui_asan_cd_open"                to "Open Asan AI advisor",
    "ui_asan_cd_send"                to "Send",
    "ui_asan_cd_voice"               to "Voice input",
