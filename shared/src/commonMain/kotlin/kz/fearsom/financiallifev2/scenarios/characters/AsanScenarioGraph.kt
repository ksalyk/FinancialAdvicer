    ...
    override val events: Map<String, GameEvent> = buildMap {
        ...
        put(
            "intro", event(
                ...
                message = story(
                    ...
                    """,
                    """
                    На руках {capital}. Долг по кредитке 120 000 тг, аренда и жизнь съедают большую часть дохода. И именно в этот момент звонит Дима с предложением, которое звучит как быстрый выход из режима вечного догоняющего: крипта, x2 за месяц, «надо только не тормозить».
                    """
                ),
                flavor = "😰",
                options = listOf(
        ...
        put(
            "crypto_result", event(
                ...
                message = story(
                    ...
                    """,
                    """
                    На бирже осталось 60 000 тг. И как раз сейчас Дима возвращается с классической репликой всех убыточных авантюр: «Это просто просадка, надо добирать на дне». Вопрос уже не про рынок. Вопрос про способность Асана вовремя выйти из собственной иллюзии.
                    """
                ),
                flavor = "😬",
                options = listOf(
        ...
        put(
            "total_loss", event(
                ...
                message = story(
                    ...
                    """,
                    """
                    Потеря 150 000 тг бьёт не только по счёту. Она бьёт по образу себя как разумного человека. И это, возможно, самый полезный удар за всё последнее время. Потому что теперь фраза «быстрые деньги» наконец звучит не как шанс, а как предупреждение.
                    """,
                    """
        ...
        put(
            "job_offer", event(
                ...
                message = story(
                    """
                    Оффер приходит как раз тогда, когда Асан почти успел привыкнуть к своей текущей жизни. Стартап предлагает 700 000 тг и почти рекламный билет в следующую версию себя: быстрее рост, сильнее команда, меньше бюрократии, больше ощущения, что ты не винтик, а часть чего-то настоящего.
                    """,
                    """
