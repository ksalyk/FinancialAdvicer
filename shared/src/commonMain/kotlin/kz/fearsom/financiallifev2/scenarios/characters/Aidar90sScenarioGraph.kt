...
class Aidar90sScenarioGraph : ScenarioGraph() {
    ...
    override val events: Map<String, GameEvent> = buildMap {
        ...
        put("intro", event(
            id = "intro",
            message = """
                1993 год. Алматы. Хаос. 💸
                Зарплату задерживают на 3 месяца. 
                Родители вложили все в ваучеры «Алем» — теперь говорят, что это пустышка.
                
                На руках: {capital} тг.
                Доход: {income} тг (если повезет).
                
                Звонит отец: «Сын, пришли какие-то люди. Обещают вернуть деньги за ваучеры, если вложим еще».
                Что делать?
            """.trimIndent(),
            flavor = "📼",
            options = listOf(
        ...
        put("parents_conflict", event(
            id = "parents_conflict",
            message = """
                Отец обиделся. «Ты ничего не понимаешь!».
                Но люди ушли. Пока тихо.
                
                На работе говорят: могут заплатить продукцией (сахар, масло) вместо денег.
                Брать натурой или ждать деньги?
            """.trimIndent(),
            flavor = "📞",
        ...
        put("parents_lost_money", event(
            ...
            message = """
                😱 Они отдали тебе последние 40к и «новые инвесторы» исчезли.
                Это была та же пирамида, под другим названием.
                
                Отец в больнице с сердцем.
                Теперь ты главный кормилец.
            """.trimIndent(),
            flavor = "💔",
        ...
        put("market_opportunity", event(
            ...
            message = """
                На барахолке «Барохолка» предлагают партию китайских часов.
                Вложение: 30 000 тг.
                Слухи: можно продать в 3 раза дороже, если провезти через границу без проблем.
                
                Риск: Таможня или кидалы.
            """.trimIndent(),
            flavor = "⌚",
        ...
        put("watches_result", event(
            ...
            message = """
                📦 Партия пришла.
                Вариант А: Таможня пропустила. Спрос бешеный.
                Вариант Б: Подделка. Никому не нужны.
            """.trimIndent(),
            flavor = "📦",
...
//                    conditions = listOf(cond(KNOWLEDGE, LT, 25L))
        ...
        put("tenge_introduction", event(
            ...
            message = """
                📰 НОВОСТИ: 15 ноября 1993 — ввели тенге!
