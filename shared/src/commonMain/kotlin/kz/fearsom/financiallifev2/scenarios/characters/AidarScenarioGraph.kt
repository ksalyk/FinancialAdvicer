    ...
    private fun aidar2005Events(): Map<String, GameEvent> = buildMap {
        put("intro", event(
            ...
            message = story(
                ...
                """,
                """
                На счету {capital}. Доход {income} тг в месяц. После расходов остаётся слишком мало для ошибки, но именно сейчас друг зовёт в мелкую торговую схему с телефонами, а семья ждёт, что Айдар станет первым, кто вытащит их из постоянной нехватки.
                """
            ),
            options = listOf(
