...
license: MIT
description: >
  Use when working on Jetpack Compose or Compose Multiplatform (KMP/CMP) code —
  @Composable functions, ViewModel/StateFlow/MVI state holders, recomposition and
  performance, Navigation 3, Koin/Hilt DI, Ktor networking, Room, DataStore,
  Paging 3, Coil image loading, animations, accessibility, expect/actual platform
  code, Gradle/version-catalog setup, or Compose testing. Covers Android, iOS,
  Desktop, and Web targets. Also invokable explicitly via /compose-skill.
---
