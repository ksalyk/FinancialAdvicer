 ...
 *   - Local dev Android emulator: "http://10.0.2.2:8082/api/v1"
 *   - Local dev iOS simulator:    "http://localhost:8082/api/v1"
 *   - Production:                 "https://api.yourapp.com/api/v1"
 *
 * Port 8082 is used to avoid conflict with the landing webpack dev server (port 8081).
 */
